...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 902;
    private static final int ACTION_DRINK_WATER_ID = 243;
    /**
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        NotificationCompat.Action action = new NotificationCompat
                .Action(R.drawable.ic_cancel_black_24px,
                "No, thanks",
                pendingIntent);
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent drinkWaterPendingIntent = PendingIntent.getService(context,
                ACTION_DRINK_WATER_ID,
                waterReminderIntent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        //      DONE (15) Create an Action for the user to tell us they've had a glass of water
        NotificationCompat.Action drinkWaterAction = new NotificationCompat
                .Action(R.drawable.ic_drink_notification,
                "I Did It!",

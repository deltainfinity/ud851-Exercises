...
public class NotificationUtils {
    ...
    public static final int MAIN_ACTIVITY_ID = 100;
    public static final int NOTIFICATION_UTILS_ID = 101;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        notificationManager.notify(NOTIFICATION_UTILS_ID, builder.build());
    }
    ...
    public static Bitmap LargeIcon(Context context) {
        ...
        Bitmap notificationBitmap = BitmapFactory.decodeResource(resources,

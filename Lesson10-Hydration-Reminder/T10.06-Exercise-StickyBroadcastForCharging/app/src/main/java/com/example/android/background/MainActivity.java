...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Intent batteryChargingIntent = registerReceiver(null, batteryChangedIntentFilter);
            ...
            int batteryStatus = batteryChargingIntent.getIntExtra(BatteryManager.EXTRA_STATUS,

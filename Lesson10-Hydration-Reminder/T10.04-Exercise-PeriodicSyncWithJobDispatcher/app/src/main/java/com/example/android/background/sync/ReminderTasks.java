...
public class ReminderTasks {
    ...
    public static final String ACTION_ISSUE_CHARGING_REMINDER_NOTIFICATION = "issue_notification";
    ...
    public static void executeTask(Context context, String action) {
        ...
        }else if(ACTION_ISSUE_CHARGING_REMINDER_NOTIFICATION.equals(action)){

...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String share = "Java on Android is just like Java anywhere else!";
    ...
    public void shareText(String text){
        ...
        Intent textChooserIntent = android.support.v4.app.ShareCompat.IntentBuilder.from(this)
                .setType(mimeType)
                .setChooserTitle(title)
                .setText(text)
                .createChooserIntent();
        startActivity(textChooserIntent);
    }

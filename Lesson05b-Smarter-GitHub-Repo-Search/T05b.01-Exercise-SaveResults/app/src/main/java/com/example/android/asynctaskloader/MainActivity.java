...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String queryURL = "QUERY_URL";

    // DONE (2) Create a static final key to store the search's raw JSON
    private static final String rawJSON = "RAW_JSON";
    ...
    public void onSaveInstanceState(Bundle outState){
        ...
        String urlText = mUrlDisplayTextView.getText().toString();
        outState.putString(queryURL, urlText);
        String rawJSONText = mSearchResultsTextView.getText().toString();
        outState.putString(rawJSON, rawJSONText);
    }

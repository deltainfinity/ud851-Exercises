...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setSizeFromPreferences(SharedPreferences sharedPreferences){
        float minSizeScale = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_size_multiplier_key),
                getString(R.string.pref_size_multiplier_default)));
